  ...
  return (
    <>
      <style>{`
        ...
        .snav-bar{display:flex;border:3px solid #1a1a1a;border-top:none;box-shadow:6px 6px 0 #1a1a1a;margin-bottom:1.75rem}
        ...
        @media(max-width:540px){.snav-item{font-size:0.88rem;padding:0.5rem 0.15rem 0.55rem;letter-spacing:0.5px}}
      `}</style>
