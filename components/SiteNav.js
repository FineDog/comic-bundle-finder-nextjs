  ...
  return (
    <>
      <style>{`
        ...
        @media(max-width:540px){.snav-item{font-size:1rem;padding:0.5rem 0.15rem 0.55rem;letter-spacing:0.5px}.snav-account{font-size:1rem;padding:0.5rem 0.5rem 0.55rem}}
      `}</style>
      ...
      <nav className="snav-bar">
        ...
        {hasPremium ? (
          ...
          <button
            ...
            style={{ background: activeAnalyzer ? "#cc1f00" : "#fffdf4", borderTop: "none", borderLeft: "none", borderBottom: "none", cursor: "pointer" }}
          >Gap Analyzer</button>
        )}
