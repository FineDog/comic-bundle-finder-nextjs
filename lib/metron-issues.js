...
//   We intentionally avoid list() and head() (both "Advanced Operations" on Vercel's
//   billing tier).  Cache reads use a plain fetch() to the public CDN URL (counted as
//   bandwidth, not an operation).  Writes use put() (a "Simple Operation"), which only
//   fires on a real cache miss.
