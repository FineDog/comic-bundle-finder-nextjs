...
// offset and zip mirror the main /api/search behaviour — pass defaults for series/arc pages.
export async function searchEbay(token, issueName, offset = 0, zip = null) {
